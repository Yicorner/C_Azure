...
void GlfwManager::createWindow(int window_width, int window_height, std::string title, bool is_fullscreen)
{
	...
	//std::cout << "In glfw_manager Framebuffer size: " << framebuffer_width << "x" << framebuffer_height << std::endl;
    //print window size
	//std::cout << "In glfw_manager Window size: " << window_width << "x" << window_height << std::endl;
