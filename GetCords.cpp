...
static int flag = 1;
int get_cords(k4a::device& device, k4a_device_configuration_t& config, int x, int y, int image_id) {
    ...
    try
    {
        ...
        // Capture a frame
        //k4a::capture capture;
        //if (!device.get_capture(&capture, std::chrono::milliseconds(10000))) // Increased timeout
        //{
        //    std::cerr << "Failed to get a capture within the timeout." << std::endl;
        //    device.close();
        //    return -1;
        //}
        ...
        //if (!color_image)
        //{
        //    std::cerr << "Failed to retrieve color image." << std::endl;
        //    device.close();
        //    return -1;
        //}
        ...
        //if (!depth_image)
        //{
        //    std::cerr << "Failed to retrieve depth image." << std::endl;
        //    device.close();
        //    return -1;
        //}
        ...
        std::ifstream depth_file("captures/" + filename, std::ios::in | std::ios::binary);
        if (!depth_file)
        {
        ...
        // Save the color and depth images as raw files (as you already did)
        // ... [Your existing code for saving images] ...

        // Now, let's test the calibration function
