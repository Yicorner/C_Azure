...
int get_cords_with_depth_image(k4a::device& device, k4a_device_configuration_t& config, int ox, int oy, k4a::image depth_image, std::vector<std::vector<float>>& body3Dlocation_list) {
        /*
        ...
        */
        ...
        {
            std::cerr << "Conversion failed. The point may not have corresponding depth data." << std::endl;
            return 0;
        }
